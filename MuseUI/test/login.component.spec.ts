...
import { LoginComponent } from '../src/app//muse/components/login/login.component';
...
describe('LoginComponent', () => {
  ...
  it('should handle to login into the system', fakeAsync(() => {
    ...
    spyAuthenticateUser = spyOn(authenticationService, 'authenticateUser').and.returnValue(Observable.create(positiveResponse));
